...
class kernel_sdpa : public Kernel_optim<FeatType, LabelType>
{
public:
    kernel_sdpa(const Params &param, DataSet<FeatType, LabelType> &dataset);
    virtual ~kernel_sdpa();
...
template <typename FeatType, typename LabelType>
kernel_sdpa<FeatType, LabelType>::kernel_sdpa(const Params &param,
...
template <typename FeatType, typename LabelType>
kernel_sdpa<FeatType, LabelType>::~kernel_sdpa()
{
}

//Deterministic
template <typename FeatType, typename LabelType>
FeatType  kernel_sdpa<FeatType, LabelType>::UpdateWeightVec(const DataPoint<FeatType, LabelType> &x)
{
    FeatType y;
